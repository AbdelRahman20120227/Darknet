...
void forward_route_layer(const route_layer l, network net)
{
	...
	for(i = 0; i < l.n; ++i){
		...
		clCopyFromHistory(l.output + offset, layer.out_h, layer.out_w, layer.clRealHxW, layer.out_c, layer.clOutput, layer.type == CONVOLUTIONAL);
		offset += (l.input_sizes[i]);
		
	}
	clRoute(l.output, l.outputs);
